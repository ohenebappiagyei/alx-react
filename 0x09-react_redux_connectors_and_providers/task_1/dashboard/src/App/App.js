...
class App extends Component {
  ...
  handleDisplayDrawer() {
    // Update Redux state instead of component state
    // Example: this.props.setNotificationDrawerVisibility(true);
  }

  handleHideDrawer() {
    // Update Redux state instead of component state
    // Example: this.props.setNotificationDrawerVisibility(false);
  }
